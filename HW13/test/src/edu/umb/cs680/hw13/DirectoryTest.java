...
class DirectoryTest  {
	...
	public void verifyDirectoryEqualitySrc() {
		...
		String[] expected= {"src","8","repo",LocalDateTime.of(2023, 11, 2, 14, 30, 2)+""};
		assertArrayEquals(expected,dirToStringArray(src));
	}
	@Test
	public void verifyDirectoryEqualityTest() {
		Directory test=(Directory) root.getChildren().get(2);
		String[] expected= {"test","1","repo",LocalDateTime.of(2023, 11, 2, 14, 30, 4)+""};
	...
	public void verifyDirectoryEqualitySrcTest() {
		...
		String[] expected= {"test-src","0","test",LocalDateTime.of(2023, 11, 2, 14, 30, 1)+""};
    ...
    void GetTotalSizeTest() {
        assertEquals(16,root.getTotalSize());
    }
