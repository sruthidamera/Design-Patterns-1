...
import edu.umb.cs680.hw13.TestFixtureInitializer;
...
class FileTest  {
	...
	public void verifyFileEqualityA() {
		File A=(File) ((Directory) root.getChildren().get(1)).getChildren().get(0);
		String[] expected= {"A.java","1","src",LocalDateTime.of(2023, 11, 2, 14, 30, 1)+""};
		assertArrayEquals(expected,FileToStringArray(A));
	}
	
	@Test
	public void verifyFileEqualityB() {
		File B=(File) ((Directory) root.getChildren().get(1)).getChildren().get(1);
		String[] expected= {"B.java","1","src",LocalDateTime.of(2023, 11, 2, 14, 30, 1)+""};
		assertArrayEquals(expected,FileToStringArray(B));
	}
	
	@Test
	public void verifyFileEqualityATest() {
		File Atest=(File) ((Directory) ((Directory) root.getChildren().get(2)).getChildren().get(0)).getChildren().get(0);
		String[] expected= {"Atest.java","1","test-src",LocalDateTime.of(2023, 11, 2, 14, 30, 1)+""};
		assertArrayEquals(expected,FileToStringArray(Atest));
	}
	
	@Test
	public void verifyFileEqualityBTest() {
		File Btest=(File) ((Directory) ((Directory) root.getChildren().get(2)).getChildren().get(0)).getChildren().get(1);
		String[] expected= {"Btest.java","1","test-src",LocalDateTime.of(2023, 11, 2, 14, 30, 1)+""};
	...
	public void verifyFileEqualityReadMe() {
		...
		String[] expected= {"readme.md","3","repo",LocalDateTime.of(2023, 11, 2, 14, 30, 1)+""};
